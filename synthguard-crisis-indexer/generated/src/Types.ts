...
export type LoaderContext = {
  ...
  readonly MockLending_HealthFactorUpdated: {
     ...
     */
    readonly get: (id: string) => Promise<Entities.MockLending_HealthFactorUpdated_t | undefined>,
    /**
     * Load the entity MockLending_HealthFactorUpdated from the storage by ID.
     * If the entity is not found, throws an error.
     */
    readonly getOrThrow: (id: string, message?: string) => Promise<Entities.MockLending_HealthFactorUpdated_t>,
    readonly getWhere: Entities.MockLending_HealthFactorUpdated_indexedFieldOperations,
    /**
     * Returns the entity MockLending_HealthFactorUpdated from the storage by ID.
     * If the entity is not found, creates it using provided parameters and returns it.
     */
    readonly getOrCreate: (entity: Entities.MockLending_HealthFactorUpdated_t) => Promise<Entities.MockLending_HealthFactorUpdated_t>,
    /**
     * Set the entity MockLending_HealthFactorUpdated in the storage.
     */
    readonly set: (entity: Entities.MockLending_HealthFactorUpdated_t) => void,
    /**
     * Delete the entity MockLending_HealthFactorUpdated from the storage.
     *
  ...
  readonly MockLending_RescueExecuted: {
    /**
     * Load the entity MockLending_RescueExecuted from the storage by ID.
     * If the entity is not found, returns undefined.
     */
    readonly get: (id: string) => Promise<Entities.MockLending_RescueExecuted_t | undefined>,
    /**
     * Load the entity MockLending_RescueExecuted from the storage by ID.
     * If the entity is not found, throws an error.
     */
    readonly getOrThrow: (id: string, message?: string) => Promise<Entities.MockLending_RescueExecuted_t>,
    readonly getWhere: Entities.MockLending_RescueExecuted_indexedFieldOperations,
    /**
     * Returns the entity MockLending_RescueExecuted from the storage by ID.
     * If the entity is not found, creates it using provided parameters and returns it.
     */
    readonly getOrCreate: (entity: Entities.MockLending_RescueExecuted_t) => Promise<Entities.MockLending_RescueExecuted_t>,
    /**
     * Set the entity MockLending_RescueExecuted in the storage.
     */
    readonly set: (entity: Entities.MockLending_RescueExecuted_t) => void,
    /**
     * Delete the entity MockLending_RescueExecuted from the storage.
     *
     * The 'deleteUnsafe' method is experimental and unsafe. You should manually handle all entity references after deletion to maintain database consistency.
     */
    readonly deleteUnsafe: (id: string) => void,
