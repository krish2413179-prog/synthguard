  ...
  let entities = {
      ...
      mockLending_HealthFactorUpdated: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MockLending_HealthFactorUpdated)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MockLending_HealthFactorUpdated.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      mockLending_RescueExecuted: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.MockLending_RescueExecuted)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.MockLending_RescueExecuted.t,
            >
          ),
          ~getKey=({id}) => id,
        )
